...
const HospitalDetail = () => {
  ...
  const hospital = filteredHospitals[0] || null;
            ...
            <div className='flex-1 w-full'>
              ...
              <div className='mt-8 flex flex-col sm:flex-row gap-3'>
                <Link
                  ...
                  className='px-5 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors duration-200 font-medium text-center'>
                  Book Appointment
                </Link>
                <Link
