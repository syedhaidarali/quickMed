      ...
      {stats.map((stat, index) => (
        <div
          ...
          <div className='flex items-center'>
            <div
              className={`w-12 h-12 flex items-center justify-center rounded-full ${stat.bgColor} ${stat.textColor}`}>
